...
public class AuctionSniperEndToEndTest {
    ...
    public void sniperJoinsAuctionUntilAuctionCloses() throws Exception {
        ...
        application.showsSniperStatusHasLostAuction(auction, 0, 0);
    }
    ...
    public void sniperMakesAHigherBidButLoses() throws Exception {
        ...
        auction.announceClosed();
        application.showsSniperStatusHasLostAuction(auction, 1000, 1098);
    }
    ...
    public void sniperWinsAnAuctionByBiddingHigher() throws Exception {
        ...
        auction.announceClosed();
        application.showsSniperStatusHasWonAuction(auction, 1098);
    }
    
    @Test
    public void startBidsForMultipleItems() throws Exception {
        auction.startSellingItem();
        ...
        application.showsSniperStatusHasWonAuction(auction, 1098);
        application.showsSniperStatusHasWonAuction(auction2, 521);
    }

    @Test
    public void sniperLosesAnAuctionWhenThePriceTooHigh() throws Exception {
        auction.startSellingItem();
        ...
        auction.announceClosed();
        application.showsSniperStatusHasLostAuction(auction, 1207, 1098);
    ...
    private void waitForAnotherEvent() throws Exception {
        auction2.hasReceivedJoinRequestFrom(ApplicationRunner.SNIPER_XMPP_ID);
